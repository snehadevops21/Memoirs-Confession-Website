...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex flex-col">
      ...
      <AnimatePresence>
        {showMusicPrompt && (
          <motion.div
            ...
            className="w-full bg-linear-to-r from-neon-purple/95 via-neon-pink/95 to-purple-900/95 text-white px-4 py-2 flex items-center justify-center gap-2 shadow-lg backdrop-blur-md text-[11px] font-medium tracking-wide text-center overflow-hidden shrink-0"
          >
      ...
      {/* Main Navbar */}
      <nav className="w-full px-4 py-3 md:px-12 flex items-center justify-between backdrop-blur-md border-b bg-[#0b0f19]/80 border-white/5 transition-all duration-300 relative">
        {/* Logo Area */}
